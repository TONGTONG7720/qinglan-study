...
@Module({ imports: [PrismaModule, AuthModule], controllers: [PrivacyController], providers: [PrivacyService, RetentionJobService, SecurityPolicyService, IdempotencyService] })
